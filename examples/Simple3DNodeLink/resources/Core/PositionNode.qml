...
/*! ***********************************************************************************************
 * PositionNode - Combines x, y, z inputs into a position vector3d output
 * ************************************************************************************************/
...
Node {
    ...
    property vector3d outputPosition: Qt.vector3d(0, 0, 0)

    /* Object Properties
     * ****************************************************************************************/
    objectType: NLSpec.ObjectType.Node
    type: Specs.NodeType.Position
    guiConfig.width: 160
    ...
    function updateOutput() {
        outputPosition = Qt.vector3d(inputX, inputY, inputZ);
        // Update the node data
        if (nodeData) {
            nodeData.data = outputPosition;
        }
    ...
    //! Create ports for position node
    function addPorts() {
        // Input ports
