...
/*! ***********************************************************************************************
 * ConeNode - A cone shape node with position, rotation, scale, dimensions, and material inputs
...
Node {
    ...
    property string shapeType: "Cone"

    /* Object Properties
     * ****************************************************************************************/
    objectType: NLSpec.ObjectType.Node
    type: Specs.NodeType.Cone
    guiConfig.width: 120
