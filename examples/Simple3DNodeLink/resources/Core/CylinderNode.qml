...
/*! ***********************************************************************************************
 * CylinderNode - A cylinder shape node with position, rotation, scale, dimensions, and material inputs
...
Node {
    ...
    property string shapeType: "Cylinder"

    /* Object Properties
     * ****************************************************************************************/
    objectType: NLSpec.ObjectType.Node
    type: Specs.NodeType.Cylinder
    guiConfig.width: 120
    ...
    //! Create ports for cylinder node
    function addPorts() {
        // Input ports
