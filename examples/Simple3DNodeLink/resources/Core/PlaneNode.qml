...
/*! ***********************************************************************************************
 * PlaneNode - A plane shape node with position, rotation, scale, dimensions, and material inputs
...
Node {
    ...
    property string shapeType: "Plane"

    /* Object Properties
     * ****************************************************************************************/
    objectType: NLSpec.ObjectType.Node
    type: Specs.NodeType.Plane
    guiConfig.width: 120
