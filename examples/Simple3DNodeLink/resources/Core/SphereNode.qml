...
/*! ***********************************************************************************************
 * SphereNode - A sphere shape node with position, rotation, scale, dimensions, and material inputs
...
Node {
    ...
    property string shapeType: "Sphere"

    /* Object Properties
     * ****************************************************************************************/
    objectType: NLSpec.ObjectType.Node
    type: Specs.NodeType.Sphere
    guiConfig.width: 120
