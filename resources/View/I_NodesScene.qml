...
Flickable {
    ...
    * ****************************************************************************************/
    ...
    property Component sceneContent: null
    ...
    * ****************************************************************************************/
    ...
    onContentXChanged: {
        if (scene && Math.abs(
                    scene.sceneGuiConfig.contentX - contentX) > 0.001) {
        ...
        if (!flickingHorizontally) {
            ...
            if (isExtendWidthNeed) {
                ...
                scene.sceneGuiConfig.contentWidth = Math.min(
    ...
    onContentYChanged: {
        if (scene && Math.abs(
                    scene.sceneGuiConfig.contentY - contentY) > 0.001) {
        ...
        if (!flickingHorizontally) {
            ...
            if (isExtendWidthNeed) {
                ...
                scene.sceneGuiConfig.contentHeight = Math.min(
