...
Canvas {
    ...
    * ****************************************************************************************/
    ...
    //! Link input position
    property vector2d   inputPos: (inputPort && inputPort._position) ? inputPort._position : Qt.vector2d(-1, -1)

    //! Link output position
    property vector2d   outputPos: (outputPort && outputPort._position) ? outputPort._position : Qt.vector2d(-1, -1)
