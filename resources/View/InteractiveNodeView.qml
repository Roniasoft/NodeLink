...
//                 var minHeight = node.autoSize ? node.calculatedMinHeight : node.minHeight;
...
//                 // Enforce minimum height
//                 if (node.autoSize) {
//                     newHeight = Math.max(newHeight, node.calculatedMinHeight);
//                 } else {
//                     newHeight = Math.max(newHeight, node.minHeight);
//                 }
...
//     //! Left Side Mouse Area - Updated with minimum size enforcement
//     MouseArea {
//         id: leftMouseArea
//         width: 20
//         cursorShape: Qt.SizeHorCursor
...
//                 var minWidth = node.autoSize ? node.calculatedMinWidth : node.minWidth;
...
//     //! Right Side Mouse Area - Updated with minimum size enforcement
//     MouseArea {
//         id: rightMouseArea
//         width: 12
//         cursorShape: Qt.SizeHorCursor
...
//                 // Enforce minimum width
//                 if (node.autoSize) {
//                     newWidth = Math.max(newWidth, node.calculatedMinWidth);
//                 } else {
//                     newWidth = Math.max(newWidth, node.minWidth);
//                 }
...
I_NodeView {
    ...
    property real nodeContentWidth: width - 40  // Account for padding
    ...
    * ****************************************************************************************/
    ...
    // Add this to InteractiveNodeView to update port widths when node resizes
    onWidthChanged: {
        nodeContentWidth = width - 40
    }

    // Initialize the content width
